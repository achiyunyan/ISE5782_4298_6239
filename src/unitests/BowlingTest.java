...
public class BowlingTest {
        ...
        public void addPin(Point p) {
                scene.geometries.add(
                                ...
                                new Cylinder(new Ray(new Point(p.getX(), 0.6, p.getZ()), new Vector(0, 1, 0)), 2, 2.2)
                                                .setEmission(new Color(WHITE)),
                                new Sphere(new Point(p.getX(), 3.1, p.getZ()), 2).setEmission(new Color(WHITE)),
                                new Cylinder(new Ray(new Point(p.getX(), 4.6, p.getZ()), new Vector(0, 1, 0)), 1, 3)
                                                .setEmission(new Color(RED)),
                                new Cylinder(new Ray(new Point(p.getX(), 5.3, p.getZ()), new Vector(0, 1, 0)), 1.01,
                                                0.6).setEmission(new Color(WHITE)),
                                new Sphere(new Point(p.getX(), 7.3, p.getZ()), 1.25).setEmission(new Color(WHITE)),
                                new Cylinder(new Ray(new Point(p.getX(), 7.6, p.getZ()), new Vector(0, 1, 0)), 1.25, 1)
                                                .setEmission(new Color(WHITE)),
        ...
        public void Bowling() {
                /*
                 * Camera camera = new Camera(new Point(-20, 20, 0), new Vector(1, -1, 0), new
                 * Vector(1, 1, 0)) //
                 * .setVPSize(150, 150).setVPDistance(100);
                 */
                /*
                 * Camera camera = new Camera(new Point(-50, 30, 0), new Vector(1, -1, 0), new
                 * Vector(1, 1, 0)) //
                 * .setVPSize(150, 150)
                 * .setVPDistance(100);
                 */
                /*
                 * Camera camera = new Camera(new Point(-60, 10, 0), new Vector(1, 0, 0), new
                 * Vector(0, 1, 0)) //
                 * .setVPSize(150, 150)
                 * .setVPDistance(100);
                 */
                ...
                ImageWriter imageWriter = new ImageWriter("Bowling", 4000, 4000);
