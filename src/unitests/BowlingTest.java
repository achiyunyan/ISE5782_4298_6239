...
public class BowlingTest {
    ...
    @Test
    public void Bowling() {
        /*Camera camera = new Camera(new Point(-20, 20, 0), new Vector(1, -1, 0), new Vector(1, 1, 0)) //
                .setVPSize(150, 150).setVPDistance(100);*/
        /*Camera camera = new Camera(new Point(-50, 30, 0), new Vector(1, -1, 0), new Vector(1, 1, 0)) //
                .setVPSize(150, 150)
                .setVPDistance(100);*/
        /*Camera camera = new Camera(new Point(-60, 10, 0), new Vector(1, 0, 0), new Vector(0, 1, 0)) //
                .setVPSize(150, 150)
                .setVPDistance(100);*/
